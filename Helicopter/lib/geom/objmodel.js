...
ObjModel.prototype.render = function(gl, uni) {
    ...
    for(let i = 0; i < this.meshes.length; i++){
        ...
        gl.uniform3fv(uni.uColor, this.meshes[i].color);
        gl.drawElements(gl.TRIANGLES, this.meshes[i].nVerts,gl.UNSIGNED_INT, this.meshes[i].start*4);
    }
